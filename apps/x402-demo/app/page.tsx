    ...
    <>
      ...
      <section className="bg-[#F5F0E8] px-8 pt-12 pb-0 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-3 max-w-lg mx-auto border-t border-gray-300/60">
      ...
      <footer className="border-t border-gray-200 py-6 px-8 text-center space-y-3">
        <div className="flex items-center justify-center gap-4">
          <a
            href="https://github.com/francoperez03/x402-stellar-demo"
            target="_blank"
          ...
          <span className="text-gray-300">·</span>
          <a
            href="https://www.linkedin.com/in/francoperez03/"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-black transition-colors"
          >
